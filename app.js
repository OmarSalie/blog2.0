...
app.post('/user', function(req, res) {
    ...
    requestedUser.body = req.sanitize(requestedUser.body);

    console.log(requestedUser);

    Users.create(requestedUser, function(err, createdUser) {
        if (err) {
            res.render('signup');
            alert("Error");
        } else {
